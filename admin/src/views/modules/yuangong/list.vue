<template>
  <div class="main-content">
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign" 
               :header-align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('yuangong','员工培训') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="yuangongpeixunCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'员工培训':'' }}</el-button>
                <el-button v-if="isAuth('yuangong','员工培训') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="yuangongpeixunCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'员工培训':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('yuangong','员工培训') && contents.tableBtnIcon == 0" type="success" size="mini" @click="yuangongpeixunCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'员工培训':'' }}</el-button>
                <el-button v-if="isAuth('yuangong','发放工资') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="yuangonggongziCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'发放工资':'' }}</el-button>
                <el-button v-if="isAuth('yuangong','发放工资') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="yuangonggongziCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'发放工资':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('yuangong','发放工资') && contents.tableBtnIcon == 0" type="success" size="mini" @click="yuangonggongziCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'发放工资':'' }}</el-button>
                <el-button v-if="isAuth('yuangong','详细信息') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="yuangongxiangxiCrossAddOrUpdateHandler(scope.row,'cross','','[1]','已经添加了')">{{ contents.tableBtnFont == 1?'详细信息':'' }}</el-button>
                <el-button v-if="isAuth('yuangong','详细信息') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="yuangongxiangxiCrossAddOrUpdateHandler(scope.row,'cross','','[1]','已经添加了')">{{ contents.tableBtnFont == 1?'详细信息':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('yuangong','详细信息') && contents.tableBtnIcon == 0" type="success" size="mini" @click="yuangongxiangxiCrossAddOrUpdateHandler(scope.row,'cross','','[1]','已经添加了')">{{ contents.tableBtnFont == 1?'详细信息':'' }}</el-button>
    ...
    <yuangongpeixun-cross-add-or-update v-if="yuangongpeixunCrossAddOrUpdateFlag" :parent="this" ref="yuangongpeixunCrossaddOrUpdate"></yuangongpeixun-cross-add-or-update>
    ...
    <yuangongxiangxi-cross-add-or-update v-if="yuangongxiangxiCrossAddOrUpdateFlag" :parent="this" ref="yuangongxiangxiCrossaddOrUpdate"></yuangongxiangxi-cross-add-or-update>
